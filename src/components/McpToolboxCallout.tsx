      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        <div className="rounded-xl border border-amber-color/12 bg-muted/20 dark:bg-[#0B1220]/60 p-3.5">
          ...
          <div className="flex items-center gap-2 bg-[#061923] border border-border-color/60 rounded-lg px-3 py-2">
            <code
              tabIndex={0}
              className="font-mono text-[11px] text-cyan overflow-x-auto whitespace-nowrap flex-1 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan"
            >
        ...
        <div className="rounded-xl border border-amber-color/12 bg-muted/20 dark:bg-[#0B1220]/60 p-3.5">
          ...
          <div className="flex items-center gap-2 bg-[#061923] border border-border-color/60 rounded-lg px-3 py-2">
            <code
              tabIndex={0}
              className="font-mono text-[11px] text-emerald-color overflow-x-auto whitespace-nowrap flex-1 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-color"
            >
