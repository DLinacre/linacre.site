  ...
  const offerings: Offering[] = [
    {
      ...
      price: 'From £1,800',
      description:
        'Deep technical review of your architecture, security, performance, and developer experience.',
      deliverables: [
    ...
    },
    {
      ...
      price: 'From £6,500',
      description:
        'End-to-end build of production-grade tools, automation platforms, or AI integrations.',
      deliverables: [
    ...
    },
    {
      ...
      price: '£2,400 / month',
      description:
        'Dedicated fractional engineering time for ongoing improvements and rapid iteration.',
      deliverables: [
    ...
    >
      ...
      >
        ...
        <p className="text-base text-muted-foreground leading-relaxed max-w-2xl mx-auto">
          I help engineering groups ship faster, automate operations, and implement secure,
          high-throughput systems. Select contract services are outlined below.
        </p>
        ...
        <p className="inline-flex items-center gap-2 font-mono text-xs text-emerald-color bg-emerald-color/10 border border-emerald-color/25 px-3 py-1.5 rounded-full">
          <span
            className="w-1.5 h-1.5 rounded-full bg-emerald-color animate-pulse"
            aria-hidden="true"
          />
          <span>
            Next available: <strong className="font-bold">{WORK_NEXT_AVAILABLE}</strong>
          </span>
        </p>
      </motion.section>
          ...
          >
            ...
            <div className="space-y-4">
              <div className="space-y-1.5 border-b border-border-color/30 pb-4">
                ...
                <div className="text-2xl font-mono font-bold text-amber-color">
                  {offering.price}
                </div>
              </div>
      ...
      >
        <h2
          id="work-faq-heading"
          className="font-display text-2xl font-bold tracking-tight text-foreground text-center"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 max-w-4xl mx-auto">
          {WORK_FAQS.map(faq => (
            <div
              key={faq.question}
              className="bg-muted/10 border border-border-color rounded-xl p-5 space-y-2"
            >
      ...
      <motion.section
        variants={itemVariants}
        className="rounded-3xl border border-amber-color/20 bg-amber-color/[0.05] p-6 sm:p-8"
        id="work-project-brief"
      >
        <div className="flex flex-col justify-between gap-6 lg:flex-row lg:items-center">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-2 font-display text-2xl font-bold tracking-tight text-foreground">
              Send the problem, constraints, and desired outcome.
            </h2>
            <p className="mt-3 text-sm leading-7 text-muted-foreground">
              You do not need a polished specification. A useful project brief can be five
              sentences: who the user is, what is failing now, what success looks like, the
              deadline, and the available budget. I will reply with the clearest next step —
              including when the honest answer is that you do not need a custom build.
            </p>
          </div>
          <a
            href="/contact?project=brief"
            className="inline-flex shrink-0 items-center justify-center gap-2 rounded-xl bg-amber-color px-5 py-3 font-mono text-xs font-bold text-[#031018] hover:bg-amber-glow"
          >
