...
export default function App() {
  const [activeTab, setActiveTab] = useState<string>(() =>
    getTabFromLocation(window.location.pathname, window.location.hash),
  );
    ...
    <MotionConfig reducedMotion="user">
      ...
      `,
        ...
        <AnimatePresence>
          {isOffline && (
            ...
            >
              ...
              <span>
                CONNECTIVITY INTERRUPTED: Running in offline mode. Local state and custom projects
                are preserved.
              </span>
            </motion.div>
          )}
        ...
        <main
          id="main-content"
          role="main"
          className="flex-1 max-w-6xl w-full mx-auto px-4 sm:px-6 py-10 sm:py-14 pb-28 space-y-12"
        >
          <ErrorBoundary>
        ...
        <MobileBottomNav activeTab={activeTab} setActiveTab={setActiveTab} openMore={openPalette} />
        <Footer />
      </div>
    </MotionConfig>
  );
